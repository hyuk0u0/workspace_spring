...
public class UploadAjaxController {
	...
	@ResponseBody
	@RequestMapping(value = "/getUpload/{bno}", method = RequestMethod.GET)
	public List<String> getUpload(@PathVariable("bno") Integer bno) {
		
		
		return marketBoardService.getUpload(bno);
	}
}
